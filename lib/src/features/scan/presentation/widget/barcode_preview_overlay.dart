...
class BarcodePreviewOverlay extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<BarcodePreviewOverlay> createState() =>
      _BarcodePreviewOverlayState();
}

class _BarcodePreviewOverlayState extends ConsumerState<BarcodePreviewOverlay> {
    ...
    try {
      ...
      for (Barcode barcode in barcodes) {
        ...
        if (_scanArea.contains(
          ...
          // stop scanning
          widget.state.analysisController!.stop();
          ...
          if (mounted) {
            ...
            try {
              ...
              Future.delayed(const Duration(seconds: 1), () {
                appSnackBar(context, Colors.red, e.toString());
              });
              break;
            }
          ...
          widget.state.analysisController!.start();
